...
public interface WalletDao {
    ...
    @MapInfo(keyColumn = "walletId", keyTable = "w", valueColumn = "transactionId", valueTable = "t")
    @Query("SELECT * FROM transaction_table AS t JOIN wallet_table AS w ON t.walletId = w.walletId")
